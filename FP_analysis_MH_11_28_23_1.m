...
path2data = 'C:\Users\Anacker1\Desktop\Fiber-Data\Fibers\MH\Y MAZE\DAY7-Reversal1\'; %Location of the data
path2savefolder = 'C:\Users\Anacker1\Desktop\Fiber-Data\Results\DAY7-Reversal1-heatmapcheck\'; %Path to save
...
Animals_Right_correct = [1 2 3 4 7]; %% 5 and 6 had it on the left side. Mouse 1 from the first cohort had reward on the right
...
MiceperFile = 1;
min2remove = 0.016; % Minutes to remove from the beginning of the recording
...
for m = 1:Nmice
    % % Define the path to the mouse and find the folders to%3:Nmice
    % analyze:Nmice///1
...
% %                     %
            ...
            for trial_analysis = 1
                ...
                if (~isempty(intersect(str2double(mice_list(m).name(end)),Animals_Right_correct)) && Right_choice) || ...
                        (isempty(intersect(str2double(mice_list(m).name(end)),Animals_Right_correct)) && Right_choice == 0)
                    Trial_correct = 1;
